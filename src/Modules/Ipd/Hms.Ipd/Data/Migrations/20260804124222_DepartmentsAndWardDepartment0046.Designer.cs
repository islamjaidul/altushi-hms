...
namespace Hms.Ipd.Data.Migrations
{
    ...
    [Migration("20260804124222_DepartmentsAndWardDepartment0046")]
    partial class DepartmentsAndWardDepartment0046
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hms.Ipd.Data.Department", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("BranchId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_department_branch_id_name");

                    b.ToTable("department", "ipd");
                });

            modelBuilder.Entity("Hms.Ipd.Data.DepartmentStaff", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_department_staff");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_department_staff_user_id");

                    b.HasIndex("DepartmentId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_department_staff_department_id_user_id")
                        .HasFilter("active");

                    b.ToTable("department_staff", "ipd");
                });
            ...
            modelBuilder.Entity("Hms.Ipd.Data.Ward", b =>
                {
                    ...
                    b.HasIndex("DepartmentId")
                        .HasDatabaseName("ix_ward_department_id");
            ...
            modelBuilder.Entity("Hms.Ipd.Data.DepartmentStaff", b =>
                {
                    b.HasOne("Hms.Ipd.Data.Department", null)
                        .WithMany()
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_department_staff_department_department_id");
                });
            ...
            modelBuilder.Entity("Hms.Ipd.Data.Ward", b =>
                {
                    b.HasOne("Hms.Ipd.Data.Department", null)
                        ...
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ward_department_department_id");
                });
