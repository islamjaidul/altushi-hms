...
| [0046-departments-and-nursing-receive](0046-departments-and-nursing-receive/spec.md) | Departments above wards; department-scoped nursing station with an explicit receive step capturing arrival vitals + handover | Done | §5 M6, §5A.2 R5, §7, §12 | 2026-08-04 |
| [0047-discharge-certificate-document](0047-discharge-certificate-document/spec.md) | The discharge certificate had no document: render the frozen body as a printable sheet, editable summary pre-issue, kind-valid admission list | Done | §5 M6, §7 | 2026-08-04 |
...
| [0052-payroll-money-correctness](0052-payroll-money-correctness/spec.md) | Payroll money correctness — unpaid leave is paid in full, the carried shortfall is an asset nothing backs, and the run state machine is unguarded | Done | §5 M16 (US16.1), §6.6, §11 | 2026-08-06 |
| [0053-cicd-pipeline](0053-cicd-pipeline/spec.md) | A CI/CD pipeline that is green when the product is good, and deploys when it is — a native date input that had been red for days and masking every gate behind it, a migration gate that had never once run, docs commits no longer building, image built in CI not on the 3 GB VM, approval-gated deploy with backup, health check and rollback | Done | §8 N6, §8 N3, §16 | 2026-08-06 |
| [0054-hr-payroll-industry-standard](0054-hr-payroll-industry-standard/spec.md) | M16 HR & Payroll raised to an industry-standard HRMS — gap analysis + module PRD (reports, period standard, dashboards, employee timeline, lifecycle, compensation, self-service) | In Progress | §5 M16, §5A-16/17, §3.4, §7, §10, §11, §12, §13 I8, §16 | 2026-08-06 |
| [0055-hr-reporting-and-period-standard](0055-hr-reporting-and-period-standard/spec.md) | M16 Phase 1 — make it answerable: the period standard, the report centre and 26 registers, the HR command centre and manager dashboard, the employee timeline and service record, the activity log and the menu restructure | Done | §5 M16, §5A-17, §5A-20, §7, §12, §16, module PRD §12–§15 | 2026-08-06 |
| [0056-hr-employment-lifecycle](0056-hr-employment-lifecycle/spec.md) | M16 Phase 2 — close the employment lifecycle: employment type, probation confirm/extend, dependants and nominees, typed documents and licences with expiry, separation + clearance + final settlement, employer-edited letters, and notification switches | Done | §5 M16, §5A-16/17, §7, §10, §11, §12, §16, module PRD §5.3/§7.1/§9/§17 | 2026-08-06 |
| [0057-hr-complete-the-money](0057-hr-complete-the-money/spec.md) | M16 Phase 3 — complete the money: loans and advances with a recovery floor that defers rather than skips, the PF/welfare/tax member ledger the run had never written, tax statements and TDS, bonus, increment and promotion runs, variance review before approval, salary hold, disbursement with a bank file, and a real payslip document | Done | §5 M16, §5A-15/16, §3.4, §6.6, §11, §12, module PRD §5.6/§7.7-7.9/§9 | 2026-08-06 |
| [0058-hr-time-depth](0058-hr-time-depth/spec.md) | M16 Phase 4 — time depth: the device registry and health surface, employee regularization producing the one audited correction, overtime approval and the banking flag that had never been read, comp-off with an expiring bank, roster patterns and coverage, short leave, shift swap, and week start as employer configuration | Done | §5 M16, §5A-16, §13 I8, §11, §12, module PRD §5.4/§7.4-7.5/§9 | 2026-08-06 |
| [0059-hr-self-service-and-the-rest](0059-hr-self-service-and-the-rest/spec.md) | M16 Phase 5 — self-service and the rest: the one month grid three specs deferred, the employee's own space over everything phases 1–4 built, the leave calendar, the leave-year close that nothing had ever run, balance adjustment, and the schema + registers for training, appraisal, discipline, assets, notices and expenses | Done | §5 M16, §5A-16/21, §7, §11, §12, module PRD §5.5/§5.7/§5.8/§7.6/§7.10-7.11 | 2026-08-06 |
| [0060-hrm-deploy-was-a-no-op](0060-hrm-deploy-was-a-no-op/spec.md) | Every HRM deploy reported success and changed nothing — a hardcoded `image:` that never read `HMS_APP_IMAGE`, and a success path that printed the running digest without ever asserting it, so the health probe answered from the container the deploy was replacing | Done | §8 N6, §16 | 2026-08-06 |
