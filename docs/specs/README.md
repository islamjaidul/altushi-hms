...
| [0013-mvp-requirement-gaps](0013-mvp-requirement-gaps/spec.md) | Close the MVP requirement gaps ([M] items with no screen) + traceability matrix | In Progress | §5, §5A, §9A.2 | 2026-07-26 |
