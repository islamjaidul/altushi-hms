...
| [0053-cicd-pipeline](0053-cicd-pipeline/spec.md) | A CI/CD pipeline that is green when the product is good, and deploys when it is — red-on-every-push gate repaired, docs commits stop running the build, image built in CI not on the 3 GB VM, approval-gated deploy with health check and rollback | Draft | §8 N6, §8 N3, §16 | 2026-08-06 |
